/**
 * Library: JS-Beautify (HTML Module)
 * Purpose: Handles the re-formatting and structural alignment of HTML, XML, and template files.
 * Source: https://github.com/beautify-web/js-beautify
 * Role: Ensures the HTML source code of extracted extensions is properly indented and readable.
 */
!(function () {
  !(function () {
    "use strict";
            ...
            (i.prototype._read_comment_or_cdata = function (t) {
              ...
              return (
                "<" === t &&
                  ...
                  n) &&
                  ((e = this._create_token(p.COMMENT, n)).directives = i),
                e
              );
            }),
    ...
    var t = (function t(e) {
      var n = _[e];
      return (
        void 0 === n && ((n = _[e] = { exports: {} }), i[e](n, n.exports, t)),
        n.exports
      );
    })(18);
    e = t;
