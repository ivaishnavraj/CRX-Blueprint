/**
 * Library: JS-Beautify (CSS Module)
 * Purpose: Specifically handles the re-formatting and un-minifying of CSS, SCSS, and LESS files.
 * Source: https://github.com/beautify-web/js-beautify
 * Role: Ensures stylesheets extracted from extensions are readable.
 */
!(function () {
  !(function () {
    "use strict";
    ...
    var t = (function t(e) {
      var i = _[e];
      return (
        void 0 === i && ((i = _[e] = { exports: {} }), n[e](i, i.exports, t)),
        i.exports
      );
    })(15);
    e = t;
