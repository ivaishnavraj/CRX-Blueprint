/**
 * Library: JS-Beautify
 * Purpose: Re-formats and un-minifies obfuscated/compressed code into a human-readable structure.
 * Source: https://github.com/beautify-web/js-beautify
 * Role: Used in viewer.js to make extension scripts readable.
 */
!(function () {
  !(function () {
    "use strict";
    var n = [
        ...
        function (t, e, i) {
          ...
          ((T.prototype.allow_wrap_or_preserved_newline = function (t, e) {
            ...
            (T.prototype.handle_word = function (t) {
              ...
              this._flags.in_case_statement && f(t, ["case", "default"])
                ? (this.print_newline(),
            ...
            (T.prototype.handle_operator = function (t) {
              ...
              if (
                ...
                (this.print_token(t),
                  ...
                  this._tokens.peek().type !== p.START_BLOCK
                    ? (this.indent(),
                      this.print_newline(),
          ...
          function e(t, e) {
            ((this.raw_options = i(t, e)),
              ...
              this.indent_with_tabs &&
                ((this.indent_char = "\t"), 1 === this.indent_size) &&
                (this.indent_size = 4),
        ...
        function (t, e, i) {
          ...
          (((u.prototype = new n()).__set_whitespace_patterns = function (
            t,
            e,
          ) {
            ...
            (u.prototype.__split = function (t, e) {
              for (var i = (t.lastIndex = 0), n = [], u = t.exec(e); u; )
                (n.push(e.substring(i, u.index)),
                  ...
                  (u = t.exec(e)));
              return (
                i < e.length ? n.push(e.substring(i, e.length)) : n.push(""),
                n
              );
            }),
    ...
    var t = (function t(e) {
      var i = u[e];
      return (
        void 0 === i && ((i = u[e] = { exports: {} }), n[e](i, i.exports, t)),
        i.exports
      );
    })(0);
    e = t;
